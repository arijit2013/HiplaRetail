...
@interface ProductbycatViewController (){
...
@implementation ProductbycatViewController
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    return [_productbyCatlistInfo count];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dict = [_productbyCatlistInfo objectAtIndex:indexPath.row];
...
- (void)btnNavigate:(UIButton *)sender{
    NSDictionary *dict = [_productbyCatlistInfo objectAtIndex:(int)sender.tag];
    zoneId=[NSString stringWithFormat:@"%@",[dict objectForKey:@"zone_id"]];
